...
# message1 = Message.objects.create(sender=user1,receiver=user2,content="Hello, Jane! Could you please tell Alice that tomorrow we are going onvacation?")
# # Display the content
...
# reply_message = message1.reply_to_message(reply_content="Hi John, sure! I will forward this message to her!")
# # Display the content
