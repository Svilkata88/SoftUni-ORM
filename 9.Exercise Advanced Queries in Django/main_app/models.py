...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[RangeValidator(1990, 2023, "The release year must be between 1990 and 2023")]
    )
    rating = models.DecimalField(
        max_digits=2,
        decimal_places=1,
        validators=[RangeValidator(0, 10, "The rating must be between 0.0 and 10.0")]
    )
